    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="px-6 -mt-4 space-y-4">
        ...
        <Card className="p-5 space-y-3">
          ...
          {/* Panel map/filter/list (chức năng từ file 1, giữ style gọn theo file 2) */}
          <div className="pt-2 space-y-3">
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <span className="ml-2 font-medium">Bán kính:</span>
                <input
                  type="number"
              ...
              <div className="flex gap-2 relative">
                <Button size="sm" onClick={handleFindBranch} disabled={locating}>
                  {locating ? "Đang lấy vị trí..." : "Tìm lại"}
                </Button>
            ...
            <div className="flex items-center justify-between text-xs text-muted-foreground">
              <div>
                {displayedAtms.length ? (
                  ...
                  <span>Chưa có dữ liệu. Bấm “Tìm chi nhánh / ATM gần bạn”.</span>
                )}
              </div>
              {userPosition && (
                <span>
                  Vị trí: {userPosition.lat.toFixed(5)}, {userPosition.lon.toFixed(5)}
                </span>
              )}
            </div>
